<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="环卫工人" prop="huanweigongren">
          <el-input v-model="ruleForm.huanweigongren" 
              placeholder="环卫工人" clearable  :readonly="ro.huanweigongren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="环卫工人" prop="huanweigongren">
              <el-input v-model="ruleForm.huanweigongren" 
                placeholder="环卫工人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="指派时间" prop="zhipaishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zhipaishijian" 
                type="datetime"
                placeholder="指派时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhipaishijian" label="指派时间" prop="zhipaishijian">
              <el-input v-model="ruleForm.zhipaishijian" 
                placeholder="指派时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="打扫区域" prop="dasaoquyu">
          <el-input v-model="ruleForm.dasaoquyu" 
              placeholder="打扫区域" clearable  :readonly="ro.dasaoquyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="打扫区域" prop="dasaoquyu">
              <el-input v-model="ruleForm.dasaoquyu" 
                placeholder="打扫区域" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.zhipaishijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='huanweigongren'){
            this.ruleForm.huanweigongren = obj[o];
	    this.ro.huanweigongren = true;
            continue;
          }
          if(o=='zhipaishijian'){
            this.ruleForm.zhipaishijian = obj[o];
	    this.ro.zhipaishijian = true;
            continue;
          }
          if(o=='dasaoquyu'){
            this.ruleForm.dasaoquyu = obj[o];
	    this.ro.dasaoquyu = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiaoquhuanjing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoquhuanjingCrossAddOrUpdateFlag = false;
                  this.parent.search();
