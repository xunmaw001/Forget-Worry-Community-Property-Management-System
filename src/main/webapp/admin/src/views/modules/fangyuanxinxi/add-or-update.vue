<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否出售" prop="shifouchushou">
          <el-select v-model="ruleForm.shifouchushou" placeholder="请选择是否出售">
            <el-option
                v-for="(item,index) in shifouchushouOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否出售" prop="shifouchushou">
	      <el-input v-model="ruleForm.shifouchushou"
                placeholder="是否出售" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="房屋设备" prop="fangwushebei">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="房屋设备"
                  v-model="ruleForm.fangwushebei" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangwushebei" label="房屋设备" prop="fangwushebei">
                    <span>{{ruleForm.fangwushebei}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='shifouchushou'){
            this.ruleForm.shifouchushou = obj[o];
	    this.ro.shifouchushou = true;
            continue;
          }
          if(o=='chushoujiage'){
	    ...
	    this.ro.mianji = true;
          ...
          if(o=='fangwushebei'){
            this.ruleForm.fangwushebei = obj[o];
	    this.ro.fangwushebei = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.shouji!=''&&json.shouji){
          ...
          this.$message.error(data.msg);
            ...
            this.shifouchushouOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.fangyuanxiangqing = this.ruleForm.fangyuanxiangqing.replace(reg,'../../../ssmqh048/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
