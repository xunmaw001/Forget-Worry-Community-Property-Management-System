<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="设施名称" prop="sheshimingcheng">
          <el-input v-model="ruleForm.sheshimingcheng" 
              placeholder="设施名称" clearable  :readonly="ro.sheshimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="设施名称" prop="sheshimingcheng">
              <el-input v-model="ruleForm.sheshimingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="技术人员" prop="jishurenyuan">
          <el-input v-model="ruleForm.jishurenyuan" 
              placeholder="技术人员" clearable  :readonly="ro.jishurenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="技术人员" prop="jishurenyuan">
              <el-input v-model="ruleForm.jishurenyuan" 
                placeholder="技术人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.sheshimingcheng = true;
          ...
          if(o=='jishurenyuan'){
            this.ruleForm.jishurenyuan = obj[o];
	    this.ro.jishurenyuan = true;
            continue;
          }
          if(o=='zhipaishijian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `weixiuzhipai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.weixiuzhipaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
